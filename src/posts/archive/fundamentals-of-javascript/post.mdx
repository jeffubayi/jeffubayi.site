...
subtitle: 'JavaScript utilizes functions in just about every JS application that exists. We'll explore what it means to be a 'higher-order function' with examples!'
