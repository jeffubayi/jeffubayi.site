...
subtitle: 'React is a JavaScript library that aims to simplify development of visual interface and manage its state at any point in time, by dividing the UI into a collection of components.'
