...
```javascript
var jeff = new Developer('Jeff');
jeff.hello(); // Hello World! I am Jeff and I am a web developer
```
...
jeff.hello(); // Hello World! I am Jeff and I am a web developer
jeff.installReact(); // installing React .. Done.
```
...
var nathan = new ReactDeveloper('Jeff');
jeff.hello(); // Hello World! I am Jeff and I am a REACT developer
```
...
## 2. Declaring variables with ES6 let and const
...
## 4. Destructuring assignment for arrays and objects
...
console.log(firstName); // returns 'Jeff'
console.log(lastName); // returns 'Ubayi'
